...
class ThirdActivity : AppCompatActivity() {
    ...
    private lateinit var nakuru_button1: Button
    private lateinit var nakuru_button2: Button
    private lateinit var nakuru_button3: Button
    private lateinit var nakuru_button4: Button

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_third)

        nakuru_button1 = findViewById(R.id.btnnakuru1)
        nakuru_button2 = findViewById(R.id.btnnakuru2)
        nakuru_button3 = findViewById(R.id.btnnakuru3)
        nakuru_button4 = findViewById(R.id.btnnakuru4)

        nakuru_button1.setOnClickListener {
        ...
        nakuru_button2.setOnClickListener {
        ...
        nakuru_button3.setOnClickListener {
        ...
        nakuru_button4.setOnClickListener {
